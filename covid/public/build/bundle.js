...
var app = (function () {
    ...
    /* node_modules/svelte-frappe-charts/src/components/base.svelte generated by Svelte v3.21.0 */
    const file = "node_modules/svelte-frappe-charts/src/components/base.svelte";
    ...
    // (53:8) {#each countries as c}
    function create_each_block(ctx) {
    	let option;
    	let t_value = /*c*/ ctx[9][1] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*c*/ ctx[9][0];
    			option.value = option.__value;
    			add_location(option, file$1, 53, 8, 1242);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(53:8) {#each countries as c}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Will I get infected?";
    			t1 = space();
    			form = element("form");
    			label0 = element("label");
    			label0.textContent = "What is your age?";
    			t3 = space();
    			...
    			add_location(h1, file$1, 32, 0, 702);
    			add_location(label0, file$1, 35, 4, 744);
    			add_location(input0, file$1, 36, 4, 781);
    			add_location(label1, file$1, 47, 4, 957);
    			attr_dev(input1, "type", "number");
    			add_location(input1, file$1, 48, 4, 1024);
    			add_location(label2, file$1, 50, 4, 1075);
    			if (/*country*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[8].call(select));
    			add_location(select, file$1, 51, 4, 1173);
    			add_location(form, file$1, 34, 0, 733);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function buildData(age, r_factor) {
    	return {
    		labels: ["Shop", "Work", "School"],
    		datasets: [{ name: "Results", values: [25, 50, 25] }]
    	};
    }
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*age, r_factor*/ 3) {
    			 $$invalidate(3, data = buildData());
    		}
    	};
